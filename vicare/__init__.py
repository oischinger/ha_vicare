...
from homeassistant.const import CONF_NAME, CONF_PASSWORD, CONF_USERNAME, CONF_SCAN_INTERVAL
...
def setup(hass, config):
    ...
    _LOGGER.info(
        "Set up PyViCare API with cacheDuration %s", str(params["cacheDuration"])
    )
