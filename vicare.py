...
def setup_platform(hass, config, add_devices, discovery_info=None):
    ...
    add_devices([ViCareSensor(t, "BoilerTemperature", TEMP_CELSIUS),
                 ViCareSensor(t, "Programs", ""), # "comfort","eco","external","holiday","normal","reduced", "standby"
                 ViCareSensor(t, "ActiveProgram", ""), # "comfort","eco","external","holiday","normal","reduced", "standby"
                 ViCareSensor(t, "ActiveMode", ""), # "standby","dhw","dhwAndHeating","forcedReduced","forcedNormal"
